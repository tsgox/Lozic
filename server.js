 ...
 */
export async function postProcess(image, { filename = 'image.png', timeoutMs = 60000, signal } = {}) {
  ...
  try {
    ...
    throw new ApiError(0, '서버에 연결할 수 없다 (서버 실행 여부와 주소를 확인하라)');
